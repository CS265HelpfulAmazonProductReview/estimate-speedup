...
gbt = GBTClassifier(labelCol='label', featuresCol="features", maxIter=500, maxDepth=8)
pipeline = Pipeline(stages=[tokenizer, remover, hashing_term_freq, inv_doc_freq, indexer, gbt])
